...
document.querySelector("#btn13").addEventListener("click", function() {
	...
	const foods = document.querySelectorAll(".foodCheckbox3:checked");
	const food = [];
	
	
/* 	for (let i =0; i <foods.length; i++) {
		food.push(foods[i].value);
	} */
	
	//for of:자바 스크립트의 향상된 for문역할
	for (const foodlist of foods) {
		food.push(foodlist.value);
	}
	
	//프로퍼티명 과 변수명이 같으면 생략 가능
