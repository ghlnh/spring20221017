...
<body>
	...
	<!-- (input+br)*6+input:s -->
	<input type="text" placeholder="이름" value="lee" name="name">
	<br>
	<input type="text" placeholder="계약명" value="gr" name="conName">
	<br>
	...
	<br>
	<input type="text" placeholder="전화번호" value="1234-5678" name="phone">
	<br>
