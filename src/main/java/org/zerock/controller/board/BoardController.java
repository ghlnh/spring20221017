...
public class BoardController {
	...
	public String modify(BoardDto board, RedirectAttributes rttr ) {
		...
		if (cnt==1) {
			rttr.addFlashAttribute("message2", board.getId() + "번 수정되었습니다.");
		}else {
			rttr.addFlashAttribute("message2", board.getId() + "번 수정되지 않았습니다.");
		}
	...
	public String remove(int id, RedirectAttributes rttr) {
		...
		if (cnt==1) {
			rttr.addFlashAttribute("message1", id +"번 게시물이 삭제되었습니다.");
		}else {
			rttr.addFlashAttribute("message1", id +"번 게시물이 삭제되지 않았습니다.");
		}
